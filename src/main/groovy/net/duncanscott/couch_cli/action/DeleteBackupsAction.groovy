...
class DeleteBackupsAction extends ListBackupsAction {

    @Override
    String getDescription() {
        'Delete backup databases at the specified couchdb.  Specify databases to include via the --tag, --olderThan, or --all options.'
    }
