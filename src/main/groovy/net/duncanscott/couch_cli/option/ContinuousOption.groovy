 ...
 */
class ContinuousOption extends BaseOption {

    ContinuousOption(AbstractAction action) {
        super(action)
        cliBuilder._(longOpt:'continuous','continuous replication or backup')
    }

    boolean getContinuous() {
        return action.optionAccessor.continuous
    }
